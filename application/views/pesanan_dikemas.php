		...
		<div class="modal fade" id="detailsModal<?= $t['transaction_id']; ?>" tabindex="-1"
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<!-- Modal Body -->
          <form action="<?= base_url('transaksi/dikemas/ubah_status/'. $t['transaction_id']) ?>" method="post">
                    ...
                    <div class="form-group row">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" name="kurir" placeholder="masukkan kurir">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-form-label col-md-2">No Resi</label>
												<div class="col-md-10">
													<input type="text" class="form-control" name="no_resi" placeholder="masukkan no resi">
												</div>
											</div>
									</div>
								</div>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-submit me-2 float-end">
