      ...
      <ul class="nav user-menu">
        ...
        <!-- <li class="nav-item dropdown has-arrow flag-nav">
          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
            <img src="<?= base_url('assets/admin/')?>assets/img/flags/us1.png" alt="" height="20">
          </a>
          <div class="dropdown-menu dropdown-menu-right">
            <a href="javascript:void(0);" class="dropdown-item">
              <img src="<?= base_url('assets/admin/')?>assets/img/flags/us.png" alt="" height="16"> English
            </a>
            <a href="javascript:void(0);" class="dropdown-item">
              <img src="<?= base_url('assets/admin/')?>assets/img/flags/fr.png" alt="" height="16"> French
            </a>
            <a href="javascript:void(0);" class="dropdown-item">
              <img src="<?= base_url('assets/admin/')?>assets/img/flags/es.png" alt="" height="16"> Spanish
            </a>
            <a href="javascript:void(0);" class="dropdown-item">
              <img src="<?= base_url('assets/admin/')?>assets/img/flags/de.png" alt="" height="16"> German
            </a>
          </div>
        </li> -->
        ...
        <!-- <li class="nav-item dropdown">
          <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
            <img src="<?= base_url('assets/admin/')?>assets/img/icons/notification-bing.svg" alt="img"> <span class="badge rounded-pill">4</span>
          </a>
              ...
              <ul class="notification-list">
                  ...
                  <a href="activities.html">
                    <div class="media d-flex">
                      <span class="avatar flex-shrink-0">
                        <img alt="" src="<?= base_url('assets/admin/')?>assets/img/profiles/avatar-02.jpg">
                      </span>
                ...
                <li class="notification-message">
                  <a href="activities.html">
                    <div class="media d-flex">
                      <span class="avatar flex-shrink-0">
                        <img alt="" src="<?= base_url('assets/admin/')?>assets/img/profiles/avatar-03.jpg">
                      </span>
                      <div class="media-body flex-grow-1">
                ...
                <li class="notification-message">
                  <a href="activities.html">
                    <div class="media d-flex">
                      <span class="avatar flex-shrink-0">
                        <img alt="" src="<?= base_url('assets/admin/')?>assets/img/profiles/avatar-06.jpg">
                      </span>
                      <div class="media-body flex-grow-1">
                ...
                <li class="notification-message">
                  <a href="activities.html">
                    <div class="media d-flex">
                      <span class="avatar flex-shrink-0">
                        <img alt="" src="<?= base_url('assets/admin/')?>assets/img/profiles/avatar-17.jpg">
                      </span>
                      <div class="media-body flex-grow-1">
                ...
                <li class="notification-message">
                  <a href="activities.html">
                    <div class="media d-flex">
                      <span class="avatar flex-shrink-0">
                        <img alt="" src="<?= base_url('assets/admin/')?>assets/img/profiles/avatar-13.jpg">
                      </span>
                      <div class="media-body flex-grow-1">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
          ...
          <div class="dropdown-menu menu-drop-user">
            <div class="profilename">
              ...
              <hr class="m-0">
              <a class="dropdown-item logout pb-0" href="<?= base_url('auth/logout/');?>"><img src="<?= base_url('assets/admin/')?>assets/img/icons/log-out.svg"
