...
class Dikemas extends CI_Controller {
    ...
    public function index()
    {
        ...
        $transaksi = $this->Transaksi_model->get_pesanan_dikemas(); // Ambil data pesanan Konfirmasi dari model
        ...
        $this->load->view('pesanan_dikemas', $data);
    }
